...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'project.create': {
    roles: ['project-manager', 'design-engineer'],
    key: 'new-project-created',
    tenantPath: ['client', 'project'],
    userPath: [],
  },
  'project.update': {
    roles: ['project-manager', 'design-engineer'],
    key: 'project-details-updated',
    tenantPath: ['client', 'project'],
    userPath: [],
  },
  'design.create': {
    roles: ['project-manager', 'organization-owner'],
    key: 'new-experiment-design',
    tenantPath: ['client', 'project', 'experiment', 'design'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['project-manager', 'design-engineer', 'organization-owner'];
