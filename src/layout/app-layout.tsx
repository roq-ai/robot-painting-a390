...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['organization-owner', 'project-manager', 'design-engineer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Designs', path: '/designs', entity: 'design', service: AccessServiceEnum.PROJECT, icon: FiEdit },
    {
      name: 'Experiments',
      path: '/experiments',
      entity: 'experiment',
