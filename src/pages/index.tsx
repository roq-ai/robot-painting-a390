...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`robot painting`}</title>

        <meta
          name="description"
          content="Experience Innovation with Robot Painting: Streamlining the Design of Experiments for Robotic Spray Painting. Your Canvas to Efficiency and Precision."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyb2JvdGljfGVufDB8fHx8MTY5NDE3MjgzM3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Innovation with Robot Painting: Streamlining the Design of Experiments for Robotic Spray Painting. Your Canvas to Efficiency and Precision.`}
            </Text>
            <Box
