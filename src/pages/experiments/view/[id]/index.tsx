            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('experiment', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/experiments/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Experiment Name" text={data?.experiment_name} />

                <FormListItem
                  label="Experiment Date"
                  text={
                    data?.experiment_date
                      ? format(parseISO(data?.experiment_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
