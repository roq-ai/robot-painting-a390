...
export function DesignListPage(props: DesignListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getDesigns({
        ...
        order: params.order,
        searchTermKeys: ['design_name.contains', 'status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.modification_date ? format(parseISO(record?.modification_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    { id: 'status', header: 'Status', accessorKey: 'status' },
    hasAccess('experiment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'experiment',
          header: 'Experiment',
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link
              ...
              href={`/experiments/view/${record.experiment?.id}`}
            >
